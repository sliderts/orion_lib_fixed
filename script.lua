...
-- Встроенные иконки (без внешних HTTP запросов)
local Icons = {
	["check"] = "rbxassetid://3944680095",
	["x"] = "rbxassetid://7072725342", 
	["minus"] = "rbxassetid://7072719338",
	["maximize"] = "rbxassetid://7072720870",
	["chevron-down"] = "rbxassetid://7072706796",
	["settings"] = "rbxassetid://3944703587",
	["home"] = "rbxassetid://3610508207",
	["users"] = "rbxassetid://3610508358",
	["shield"] = "rbxassetid://3610239960",
	["crown"] = "rbxassetid://4483345875",
	["circle"] = "rbxassetid://4031889928"
}

local function GetIcon(IconName)
	return Icons[IconName] or "rbxassetid://3944703587" -- Дефолтная иконка настроек
end

-- Проверка на совместимость с различными экзекуторами
...
-- Защита GUI для синапса
if syn and syn.protect_gui then
	syn.protect_gui(Orion)
end

Orion.Parent = GetCoreGui()
...
function OrionLib:IsRunning()
	return Orion.Parent == GetCoreGui()
end
...
-- Автоматическая очистка соединений при закрытии
task.spawn(function()
...
local function SaveCfg(Name)
	...
	local success, result = pcall(function()
		...
		if writefile then
			writefile(OrionLib.Folder .. "/" .. Name .. ".txt", encoded)
		end
	end)
	
	if not success then
		warn("Orion Library - Failed to save config:", result)
	end
end

-- Улучшенная проверка клавиш
...
CreateElement("Image", function(ImageID)
	local ImageNew = Create("ImageLabel", {
		Image = GetIcon(ImageID) or ImageID or "",
		BackgroundTransparency = 1
	})
	return ImageNew
end)
...
function OrionLib:MakeNotification(NotificationConfig)
	task.spawn(function()
		...
		NotificationConfig.Image = NotificationConfig.Image or GetIcon("settings")
...
function OrionLib:MakeWindow(WindowConfig)
	...
	WindowConfig.Icon = WindowConfig.Icon or GetIcon("settings")
	WindowConfig.IntroIcon = WindowConfig.IntroIcon or GetIcon("settings")
	...
	local WindowStuff = AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 10), {
		...
		SetChildren(SetProps(MakeElement("TFrame"), {
			...
			AddThemeObject(SetChildren(SetProps(MakeElement("Frame"), {
				...
				AddThemeObject(SetProps(MakeElement("Image", GetIcon("circle")), {
					Size = UDim2.new(1, 0, 1, 0),
				}), "Second"),
	...
	AddConnection(MinimizeBtn.MouseButton1Up, function()
		if Minimized then
			...
			MinimizeBtn.Ico.Image = GetIcon("maximize")
			TweenService:Create(MainWindow, TweenInfo.new(0.5, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
	...
	function TabFunction:MakeTab(TabConfig)
		...
		TabConfig.Icon = TabConfig.Icon or GetIcon("settings")
		...
		local function GetElements(ItemParent)
			...
			function ElementFunction:AddButton(ButtonConfig)
				...
				ButtonConfig.Icon = ButtonConfig.Icon or GetIcon("settings")
		...
		if TabConfig.PremiumOnly then
			...
			SetChildren(SetProps(MakeElement("TFrame"), {
				...
				AddThemeObject(SetProps(MakeElement("Image", GetIcon("shield")), {
					Size = UDim2.new(0, 18, 0, 18),
				...
				AddThemeObject(SetProps(MakeElement("Image", GetIcon("crown")), {
				...
				AddThemeObject(SetProps(MakeElement("Label", "This part of the script is locked to Premium users. Purchase Premium to unlock all features.", 12), {
